...
set(COMPILER_FLAGS "-DF_CPU=${MCU_FREQ} -mmcu=${AVR_MCU} -Os -mcall-prologues -Wall -fpack-struct -fshort-enums -funsigned-char -ffunction-sections -fdata-sections" CACHE STRING "AVR compilation flags")
set(CMAKE_C_FLAGS "${COMPILER_FLAGS} -std=gnu99" CACHE STRING "AVR C compilation flags")
set(CMAKE_CXX_FLAGS "${COMPILER_FLAGS} -std=c++0x -felide-constructors -fpermissive -fno-exceptions -fno-threadsafe-statics" CACHE STRING "AVR C++ compilation flags")
set(CMAKE_EXE_LINKER_FLAGS "-Wl,--relax -Wl,--gc-sections -Wl,-u,vfscanf -lscanf_min -Wl,-u,vfprintf -lprintf_min ${EXTRA_LIBS}" CACHE STRING "AVR linker flags")
